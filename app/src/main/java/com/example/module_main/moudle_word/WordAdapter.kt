...
import com.example.module_main.databinding.WordItemContentBinding
import com.example.module_main.moudle_word.WordEntity
import com.example.module_main.moudle_word.WordViewModel


class WordAdapter(viewModel: WordViewModel): androidx.recyclerview.widget.ListAdapter<WordEntity, WordAdapter.WordViewHolder>(DIFF_CALLBACK) {
