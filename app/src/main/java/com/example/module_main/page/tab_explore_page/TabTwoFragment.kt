...
class TabTwoFragment<noViewModel: ViewModel,DB: FragmentTabInExploreTwoBinding> : BaseFragment<noViewModel, DB>(),
    ...
    override fun layoutId(): Int = R.layout.fragment_tab_in_explore_two
